...
async function createDb() {
    ...
    console.log("creating file");
        ...
        for (var i = 0; i < theAccounts.length; i++) {
            ...
            var aidropId = 0;
            if(amount >= BigInt("500000000000000000000000000000000")) {
                aidropId = 2;
            } else if(amount >= BigInt("1000000000000000000000000000000")) {
                aidropId = 3;
            } else if(amount >= BigInt("1000000000000000000000000000")) {
                aidropId = 4;
            } else if(amount >= BigInt("100000000000000000000000000")) {
                aidropId = 5;
            } else if(amount >= BigInt("10000000000000000000000000")) {
                aidropId = 6;
            }
            if(aidropId != 0){
