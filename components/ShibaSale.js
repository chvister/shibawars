...
export default function ShibaSale({ dogUrl, dogName, dogPrice, dogPriceTT, dogPriceFloki, onClick, onClickTT, onClickFloki }) {
    return <div className={styles.dog}>
        ...
        <Button variant="contained" onClick={onClickFloki}>Buy for {thousandSeparator(dogPriceFloki)} $FLOKI</Button>
